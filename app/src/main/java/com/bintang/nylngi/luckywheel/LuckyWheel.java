package com.bintang.nylngi.luckywheel;
...
public class LuckyWheel extends FrameLayout implements View.OnTouchListener, OnRotationListener {
     ...
     */
    public void addWheelItems(List <WheelItem> wheelItems, MediaPlayer mediaPlayer) {
    ...
    public void applyAttribute(AttributeSet attrs) {
        ...
        try {
            int backgroundColor = typedArray.getColor(R.styleable.LuckyWheel_background_color, Color.parseColor("#FFD700"));
            int arrowImage = typedArray.getResourceId(R.styleable.LuckyWheel_arrow_image, R.drawable.gold_arrow);
