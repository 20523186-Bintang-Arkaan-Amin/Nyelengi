...
class CelenganBabiYmir : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_celengan_babi_ymir)
    ...
    private fun loadTabungan(i: Int) {
        NetworkConfig().getServiceCeleng().getTabungan(i,"Babi Ymir").enqueue(object :
            Callback<Tabungan> {
