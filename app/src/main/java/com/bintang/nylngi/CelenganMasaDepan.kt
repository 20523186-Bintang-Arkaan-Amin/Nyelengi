...
class CelenganMasaDepan : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_celengan_masa_depan)
    ...
    private fun loadTabungan(i: Int) {
        NetworkConfig().getServiceCeleng().getTabungan(i,"Masa Depan").enqueue(object :
            Callback<Tabungan> {
